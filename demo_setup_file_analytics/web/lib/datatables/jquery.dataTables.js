...
(/** @lends <global> */function($, window, document, undefined) {
	...
	var DataTable = function( oInit )
	{
		...
		function _fnCalculateColumnWidths ( oSettings )
		{
			...
			for ( i=0 ; i<iColums ; i++ )
			{
				if ( oSettings.aoColumns[i].bVisible )
				{
					...
					if ( oSettings.aoColumns[i].sWidth !== null )
					{
						if (_hasNoPercent(oSettings.aoColumns[i].sWidthOrig)) { // NUTANIX CUSTOM - ENG-79302 - don't convert for percent
			...
			else
			{
				...
				for ( i=0 ; i<oSettings.aoColumns.length ; i++ )
				{
					if ( oSettings.aoColumns[i].bVisible )
					{
						...
						{
							if (_hasNoPercent(oSettings.aoColumns[i].sWidth)) { // NUTANIX CUSTOM - ENG-79302 - don't convert for percent
				...
				if (_hasNoPercent(oSettings.nTable.style.width)) { // NUTANIX CUSTOM - ENG-79302 - don't convert for percent
		 ...
		 *    } );
		 */
		this.fnAdjustColumnSizing = function ( bRedraw, autoWidth ) // NUTANIX CUSTOM - ENG-79302 - added autoWidth to allow force column sizing
		{
			var oSettings = _fnSettingsFromNode(this[DataTable.ext.iApiIndex]);
			// NUTANIX BEGIN CUSTOM - ENG-79302 {
			if (autoWidth) {
				oSettings.oFeatures.bAutoWidth = true;
			}
