...
//
// ShareCapacityDetailTableView views the table with
...
function(
  ...
  var ShareCapacityDetailTableView = BaseTableView.extend({
    ...
    createUrl: function(filterDuration, startTime, endTime) {
      ...
      this.model.getURL(interval, startTime, endTime, DataProp.SHARE);
    },
      ...
      var retArray = [
        {
          ...
          'mRender' : function(data, type, full) {
            return data[DataProp.NAME] || AppConstants.NOT_AVAILABLE;
          }
        },
        {
          ...
          'mRender': function(data, type, full) {
            let change = full[DataProp.CAPACITY_ADDED] -
              full[DataProp.CAPACITY_REMOVED];
  ...
  return ShareCapacityDetailTableView;
});
