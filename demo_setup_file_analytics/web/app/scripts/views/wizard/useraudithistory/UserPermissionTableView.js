...
//
// UserPermissionTableView enables the user to view the table with
...
define([
  ...
  // Collections
  'collections/userpermission/UserPermissionCollection'],
function(
  // Views
  BaseTableView,
  // Collections
  ...
  var UserPermissionTableView = BaseTableView.extend({
    ...
    initialize: function(options) {
      ...
      this.model = new UserPermissionCollection();

      this.setUrlParams(options.actionTargetName);
  ...
  return UserPermissionTableView;
});
